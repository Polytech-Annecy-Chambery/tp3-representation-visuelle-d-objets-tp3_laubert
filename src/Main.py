...
#    wall3 = Wall({'position':[3,0,0],'width':5,'height':5,'orientation':0})
#    wall4 = Wall({'position':[-5,0,0],'width':3,'height':5,'orientation':90})  
    house = House({'position': [-3, 1, 0], 'orientation':0})
    house.add(wall1).add(wall2)
